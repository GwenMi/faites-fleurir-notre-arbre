...
const PRODUCTS = [
  ...
  },
  {
    ...
    label: "Kit Focus Standard",
    price: "À partir de 4,90 €",
    unit: "/ collaborateur",
    badge: null,
    tags: ["entreprise"],
    desc: "Graines, pastille de semis et étiquette personnalisée aux couleurs de votre entreprise. Idéal pour séminaires et cadeaux collaborateurs.",
    features: ["Étiquette à votre logo", "Graine & pastille de semis", "Message personnalisé", "Emballage soigné"],
  ...
  },
  {
    ...
    label: "Kit Focus Premium",
    price: "À partir de 6,90 €",
    unit: "/ collaborateur",
    badge: "Premium ✨",
    tags: ["entreprise"],
    desc: "La formule complète avec emballage premium et sac coton recyclé à votre logo. Parfait pour des événements corporate haut de gamme.",
    features: ["Étiquette & sac coton à votre logo", "Graine & pastille de semis", "Message personnalisé", "Emballage premium", "Devis sur mesure"],

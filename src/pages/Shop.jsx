...
const PRODUCTS = [
  {
    ...
    unit: "/ invité",
    badge: null,
    tags: ["mariage", "bapteme", "communion", "anniversaire", "maison_hotes"],
  ...
  },
  {
    ...
    unit: "/ collaborateur",
    badge: "Pro 🌿",
    tags: ["entreprise", "maison_hotes"],
    desc: "Un kit personnalisé aux couleurs de votre entreprise ou établissement — logo, message, graine au choix. Idéal pour séminaires, cadeaux collaborateurs, accueil clients.",

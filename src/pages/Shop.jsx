...
const PRODUCTS = [
  ...
  {
    id: "kit_entreprise",
    label: "Kit Focus & Organisation",
    price: "À partir de 4,90 €",
    unit: "/ collaborateur",
    badge: "Pro 🌿",
    tags: ["entreprise"],
    desc: "Un kit personnalisé aux couleurs de votre entreprise — logo, message, graine au choix. Idéal pour séminaires, cadeaux collaborateurs, accueil clients.",
    features: ["Étiquette à votre logo", "Graine & pastille de semis", "Message personnalisé", "Emballage soigné", "Devis sur mesure pour grandes quantités"],
  ...
  {
    id: "kit_naturel_hotes",
    label: "Kit Naturel Cire d'Abeille",
    price: "À partir de 5 €",
    unit: "/ unité",
    badge: "Artisanal 🐝",
    tags: ["maison_hotes"],
    desc: "Un galet de cire d'abeille française gravé à votre logo, dans une coupelle hexagonale en bois. 6 usages du quotidien — entretien du bois, cuir, lèvres… Idéal pour les maisons d'hôtes et gîtes.",
    features: ["Galet cire d'abeille avec logo en relief", "Coupelle hexagonale en bois laser", "Carte kraft 6 usages", "Option sac coton recyclé", "Sans minimum de commande"],
  ...
  {
    id: "kit_naturel_mariage",
    label: "Kit Naturel Cire d'Abeille",
    price: "À partir de 5 €",
    unit: "/ unité",
    badge: "100% naturel 🐝",
    tags: ["mariage", "bapteme", "communion", "anniversaire", "entreprise"],

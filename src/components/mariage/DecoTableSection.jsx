...
const DECO_KITS = [
  {
    ...
    priceDisplay: "10€ / table",
    desc: "Le chemin qui sait s'effacer et s'imposer à la fois. Un fond élégant pour vos fleurs fraîches ou un décor sobre à part entière. 3m sur chaque table, bords bruts naturels.",
    features: ["Chemin 3m x 30cm", "Bords bruts effet bohème", "Vendu à la table"],
    needsAmbiance: false,
    hasNotes: false,
  ...
  },
  {
    ...
    priceDisplay: "18€ / table",
    desc: "Vous choisissez les fleurs, nous préparons le reste. Mousse sèche humidifiable fixée sur les bords, prête à accueillir la composition de votre fleuriste. Piquez le matin, posez sur les tables.",
    features: ["Chemin 3m x 30cm", "Mousse sèche sur les bordures humidifiable", "Compatible fleurs fraîches ou séchées", "Vendu à la table"],
    needsAmbiance: false,
    hasNotes: true,
    qtyLabel: "Nombre de tables",
    unit: "tables",
  ...
  },
  {
    ...
    priceDisplay: "55€ / table",
    desc: "Fait main, expédié prêt. La composition florale séchée est déjà fixée sur les bords. Il ne manque que vos bougies et vos verres au centre. Un décor qui dure pendant tout le repas, et au-delà.",
    features: ["Chemin 3m x 30cm", "Mousse sèche + fleurs séchées sur les bordures", "Ambiance florale assortie au coloris tissu", "Centre de table libre", "Vendu à la table"],
    needsAmbiance: true,
    hasNotes: true,
    qtyLabel: "Nombre de tables",
    unit: "tables",
  ...
  },
  {
    id: "nœud-essentiel",
    emoji: "🎀",
    badge: "Lot min. 20 pcs",
    badgeColor: "bg-stone-400",
    name: "Nœud de chaise Essentiel",
    priceDisplay: "10€ / pièce — lot min. 20 pcs (200€)",
    desc: "Le ruban naturel qui change tout. Une broche dorée avec mousse intégrée accueille les fleurs fraîches de votre fleuriste le matin. Résultat : chaque chaise devient un élément de décor à part entière.",
    features: ["Ruban tissu naturel 1,5m", "Broche plateau dorée avec mousse sèche humidifiable", "Compatible fleurs fraîches — piquez le jour J", "Commande minimum : 20 pièces"],
    needsAmbiance: false,
    hasNotes: true,
    qtyLabel: "Quantité (min. 20)",
    unit: "pièces",
    minQty: 20,
    calcNote: (n) => `${n} pièces = ${n * 10} € TTC`,
  },
  {
    id: "nœud-premium",
    emoji: "🌷",
    ...
    priceDisplay: "16€ / pièce — lot min. 20 pcs (320€)",
    desc: "La touche finale sur chaque chaise. Tissu naturel, broche dorée, composition florale séchée faite main — assorti à votre chemin de table. Aucun fleuriste, aucun stress le jour J.",
    features: ["Ruban tissu naturel 1,5m", "Broche plateau dorée avec composition florale séchée", "Fait main — ambiance florale assortie", "Commande minimum : 20 pièces"],
    needsAmbiance: true,
    hasNotes: true,
    qtyLabel: "Quantité (min. 20)",
    unit: "pièces",
    minQty: 20,
    calcNote: (n) => `${n} pièces = ${n * 16} € TTC`,
  },
  {
    id: "pack-essentiel",
    emoji: "📦",
    ...
    priceDisplay: "115€ / table de 10",
    desc: "La cohérence sans l'effort. Chemin et nœuds dans le même tissu naturel, même coloris. Votre fleuriste intervient sur les deux — tout est prévu pour lui.",
    features: ["1 chemin 3m + mousse par table", "10 nœuds avec broche mousse par table", "Même coloris chemin et nœuds", "Compatible fleuriste"],
    needsAmbiance: false,
    hasNotes: true,
    qtyLabel: "Nombre de tables",
    unit: "tables",
  ...
  },
  {
    ...
    priceDisplay: "205€ / table de 10",
    desc: "Quand tout est assorti, ça se voit. Chemin fleuri et nœuds de chaise dans la même ambiance florale, même tissu naturel. Fait main, expédié prêt à poser. Aucune coordination le jour J.",
    features: ["1 chemin fleuri 3m par table", "10 nœuds Premium avec broche florale par table", "Même ambiance florale chemin et nœuds", "Fait main", "Livraison soignée"],
    needsAmbiance: true,
    hasNotes: true,
    qtyLabel: "Nombre de tables",
    unit: "tables",

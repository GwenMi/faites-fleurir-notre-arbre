...
const DECO_KITS = [
  ...
  },
  {
    ...
    features: ["Ruban tissu naturel 1,5m", "Broche plateau dorée avec mousse sèche humidifiable", "Compatible fleurs fraîches — piquez le jour J", "Commande minimum : 20 pièces", "Délai de traitement 5–7 jours ouvrés"],
    needsAmbiance: false,
    hasNotes: true,
  ...
  },
  {
    ...
    features: ["Ruban tissu naturel 1,5m", "Broche plateau dorée avec composition florale séchée", "Fait main — ambiance florale assortie", "Commande minimum : 20 pièces", "Délai de traitement 7–10 jours ouvrés"],
    needsAmbiance: true,
    hasNotes: true,
    qtyLabel: "Quantité (min. 20)",
    unit: "pièces",
